...
- OBJECIÓN ≠ RECHAZO. "Está caro", "lo voy a pensar", "¿funcionará?" NO son un no — son dudas que se RESUELVEN:
  ...
  · "¿funciona? / ¿es confiable?" → respaldo real: DIGEMID + BPM + la expectativa honesta (constancia, se nota acumulado) + muchas clientas lo notan. JAMÁS testimonios inventados con nombres, cifras mágicas ni "garantizado".
